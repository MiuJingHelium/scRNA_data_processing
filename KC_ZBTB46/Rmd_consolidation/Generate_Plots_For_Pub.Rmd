...
## Supp: whole celltype dimplot

```{r}
whole@meta.data <- whole@meta.data %>% mutate(
  annotation_main_V2 = case_match(
    annotation_main,
    "Cycling NK" ~ "NK",
    "Proliferating Mono/Mac" ~ "Mono/Mac",
...
```{r}
DimPlot(whole, reduction = "tsne",group.by = "annotation_main_V2")
```
...
g <- DimPlot(whole, reduction = "tsne",group.by = "annotation_main_V2")
ggsave(filename = paste0(outdir,"Supp_Whole_TSNE_celltype_unsplit.pdf"), plot = g, units = "cm",height = 10,width = 12)
g <- DimPlot(whole, reduction = "tsne",group.by = "annotation_main_V2",split.by = "orig.ident")
ggsave(filename = paste0(outdir,"Supp_Whole_TSNE_celltype_split.pdf"), plot = g, units = "cm",height = 10,width = 20)
```
## Supp cell type highlight: split and unsplit

```{r}
celltype_pal_whole <- gg_color_hue(9)
...
```{r}
table(whole$annotation_main_V2)
```
...
DimPlot(whole,reduction = "tsne",group.by = "highlight") + 
  scale_color_manual(values = c("EC" = celltype_pal_whole[2],"Fibroblast" = celltype_pal_whole[3]),na.value = "grey90")
g <- DimPlot(whole,reduction = "tsne",group.by = "highlight") + 
  scale_color_manual(values = c("EC" = celltype_pal_whole[2],"Fibroblast" = celltype_pal_whole[3]),na.value = "grey90")
ggsave(filename = paste0(outdir,"Supp_Whole_TSNE_stromal_unsplit.pdf"), plot = g, units = "cm",height = 10,width = 12)
```

```{r}
p1 <- DimPlot(subset(whole, subset = orig.ident == "Control"),reduction = "tsne",group.by = "highlight") + 
  scale_color_manual(values = c("EC" = celltype_pal_whole[2],"Fibroblast" = celltype_pal_whole[3]),na.value = "grey90") + ggtitle("Control")
p2 <- DimPlot(subset(whole, subset = orig.ident == "ZBTB46"),reduction = "tsne",group.by = "highlight") + 
  scale_color_manual(values = c("EC" = celltype_pal_whole[2],"Fibroblast" = celltype_pal_whole[3]),na.value = "grey90") + ggtitle("ZBTB46")
g <- gridExtra::grid.arrange(grobs = list(p1,p2),ncol = 2)
ggsave(filename = paste0(outdir,"Supp_Whole_TSNE_stromal_split.pdf"), plot = g, units = "cm",height = 10,width = 20)
```
### Neutrophil
...
DimPlot(whole,reduction = "tsne",group.by = "highlight") + 
  scale_color_manual(values = c("Neutrophil" = celltype_pal_whole[6]),na.value = "grey90")
g <- DimPlot(whole,reduction = "tsne",group.by = "highlight") + 
  scale_color_manual(values = c("Neutrophil" = celltype_pal_whole[6]),na.value = "grey90")
ggsave(filename = paste0(outdir,"Supp_Whole_TSNE_neutrophil_unsplit.pdf"), plot = g, units = "cm",height = 10,width = 12)
```

```{r}
p1 <- DimPlot(subset(whole, subset = orig.ident == "Control"),reduction = "tsne",group.by = "highlight") + 
  scale_color_manual(values = c("Neutrophil" = celltype_pal_whole[6]),na.value = "grey90") + ggtitle("Control")
p2 <- DimPlot(subset(whole, subset = orig.ident == "ZBTB46"),reduction = "tsne",group.by = "highlight") + 
  scale_color_manual(values = c("Neutrophil" = celltype_pal_whole[6]),na.value = "grey90") + ggtitle("ZBTB46")
g <- gridExtra::grid.arrange(grobs = list(p1,p2),ncol = 2)
ggsave(filename = paste0(outdir,"Supp_Whole_TSNE_neutrophil_split.pdf"), plot = g, units = "cm",height = 10,width = 20)
```
### DCs
...
DimPlot(whole,reduction = "tsne",group.by = "highlight") + 
  scale_color_manual(values = c("cDC" = celltype_pal_whole[1],"pDC" = celltype_pal_whole[8]),na.value = "grey90")
g <- DimPlot(whole,reduction = "tsne",group.by = "highlight") + 
   scale_color_manual(values = c("cDC" = celltype_pal_whole[1],"pDC" = celltype_pal_whole[8]),na.value = "grey90")
ggsave(filename = paste0(outdir,"Supp_Whole_TSNE_DC_unsplit.pdf"), plot = g, units = "cm",height = 10,width = 12)
```

```{r}
p1 <- DimPlot(subset(whole, subset = orig.ident == "Control"),reduction = "tsne",group.by = "highlight") + 
 scale_color_manual(values = c("cDC" = celltype_pal_whole[1],"pDC" = celltype_pal_whole[8]),na.value = "grey90") + ggtitle("Control")
p2 <- DimPlot(subset(whole, subset = orig.ident == "ZBTB46"),reduction = "tsne",group.by = "highlight") + 
  scale_color_manual(values = c("cDC" = celltype_pal_whole[1],"pDC" = celltype_pal_whole[8]),na.value = "grey90") + ggtitle("ZBTB46")
g <- gridExtra::grid.arrange(grobs = list(p1,p2),ncol = 2)
ggsave(filename = paste0(outdir,"Supp_Whole_TSNE_DC_split.pdf"), plot = g, units = "cm",height = 10,width = 20)
```
### mono-mac
...
DimPlot(whole,reduction = "tsne",group.by = "highlight") + 
  scale_color_manual(values = c("Mono/Mac" = celltype_pal_whole[5]),na.value = "grey90")
g <- DimPlot(whole,reduction = "tsne",group.by = "highlight") + 
  scale_color_manual(values = c("Mono/Mac" = celltype_pal_whole[5]),na.value = "grey90")
ggsave(filename = paste0(outdir,"Supp_Whole_TSNE_mono-mac_unsplit.pdf"), plot = g, units = "cm",height = 10,width = 12)
```


```{r}
p1 <- DimPlot(subset(whole, subset = orig.ident == "Control"),reduction = "tsne",group.by = "highlight") + 
  scale_color_manual(values = c("Mono/Mac" = celltype_pal_whole[5]),na.value = "grey90") + ggtitle("Control")
p2 <- DimPlot(subset(whole, subset = orig.ident == "ZBTB46"),reduction = "tsne",group.by = "highlight") + 
  scale_color_manual(values = c("Mono/Mac" = celltype_pal_whole[5]),na.value = "grey90") + ggtitle("ZBTB46")
g <- gridExtra::grid.arrange(grobs = list(p1,p2),ncol = 2)
ggsave(filename = paste0(outdir,"Supp_Whole_TSNE_mono-mac_split.pdf"), plot = g, units = "cm",height = 10,width = 20)
```
...
DimPlot(whole,reduction = "tsne",group.by = "highlight") + 
  scale_color_manual(values = c("NK" = celltype_pal_whole[7],"T cells" = celltype_pal_whole[9]),na.value = "grey90")
g <- DimPlot(whole,reduction = "tsne",group.by = "highlight") + 
   scale_color_manual(values = c("NK" = celltype_pal_whole[7],"T cells" = celltype_pal_whole[9]),na.value = "grey90")
ggsave(filename = paste0(outdir,"Supp_Whole_TSNE_lymphoid_unsplit.pdf"), plot = g, units = "cm",height = 10,width = 12)
```


```{r}
p1 <- DimPlot(subset(whole, subset = orig.ident == "Control"),reduction = "tsne",group.by = "highlight") + 
 scale_color_manual(values = c("NK" = celltype_pal_whole[7],"T cells" = celltype_pal_whole[9]),na.value = "grey90") + ggtitle("Control")
p2 <- DimPlot(subset(whole, subset = orig.ident == "ZBTB46"),reduction = "tsne",group.by = "highlight") + 
  scale_color_manual(values = c("NK" = celltype_pal_whole[7],"T cells" = celltype_pal_whole[9]),na.value = "grey90") + ggtitle("ZBTB46")
g <- gridExtra::grid.arrange(grobs = list(p1,p2),ncol = 2)
ggsave(filename = paste0(outdir,"Supp_Whole_TSNE_lymphoid_split.pdf"), plot = g, units = "cm",height = 10,width = 20)
```

## Supp: annotation dotplot
...
# Supp: single positive tSNE plots
...
DimPlot(SP, reduction = "tsne",group.by = "hashtag")

g <- DimPlot(SP, reduction = "tsne",group.by = "hashtag")
ggsave(filename = paste0(outdir,"Supp_hashtag_tSNE_plots_4-7-24/","Supp_Whole_TSNE_hashtag_unsplit.pdf"), plot = g, units = "cm",height = 10,width = 12)

g <- DimPlot(SP, reduction = "tsne",group.by = "hashtag",split.by = "orig.ident")
ggsave(filename = paste0(outdir,"Supp_hashtag_tSNE_plots_4-7-24/","Supp_Whole_TSNE_hashtag_split.pdf"), plot = g, units = "cm",height = 10,width = 20)
```
## lymphoid

```{r}
load(paste0(indir,"lymphoid_V2p4_sp.Robj"))
```

```{r}
DimPlot(lymphoid,reduction = "tsne",group.by = "hashtag")
```

```{r}
g <- DimPlot(lymphoid, reduction = "tsne",group.by = "hashtag")
ggsave(filename = paste0(outdir,"Supp_hashtag_tSNE_plots_4-7-24/","Supp_lymphoid_TSNE_hashtag_unsplit.pdf"), plot = g, units = "cm",height = 10,width = 12)

g <- DimPlot(lymphoid, reduction = "tsne",group.by = "hashtag",split.by = "orig.ident")
ggsave(filename = paste0(outdir,"Supp_hashtag_tSNE_plots_4-7-24/","Supp_lymphoid_TSNE_hashtag_split.pdf"), plot = g, units = "cm",height = 10,width = 20)
```
...
```{r}
g <- DimPlot(T_cells, reduction = "tsne",group.by = "hashtag")
ggsave(filename = paste0(outdir,"Supp_hashtag_tSNE_plots_4-7-24/","Supp_T_cells_TSNE_hashtag_unsplit.pdf"), plot = g, units = "cm",height = 10,width = 12)

g <- DimPlot(T_cells, reduction = "tsne",group.by = "hashtag",split.by = "orig.ident")
ggsave(filename = paste0(outdir,"Supp_hashtag_tSNE_plots_4-7-24/","Supp_T_cells_TSNE_hashtag_split.pdf"), plot = g, units = "cm",height = 10,width = 20)
```
...
```{r}
g <- DimPlot(NK, reduction = "tsne",group.by = "hashtag")
ggsave(filename = paste0(outdir,"Supp_hashtag_tSNE_plots_4-7-24/","Supp_NK_TSNE_hashtag_unsplit.pdf"), plot = g, units = "cm",height = 10,width = 12)

g <- DimPlot(NK, reduction = "tsne",group.by = "hashtag",split.by = "orig.ident")
ggsave(filename = paste0(outdir,"Supp_hashtag_tSNE_plots_4-7-24/","Supp_NK_TSNE_hashtag_split.pdf"), plot = g, units = "cm",height = 10,width = 20)
```

## myeloid

```{r}
load(paste0(indir,"myeloid_V2p4_sp.Robj"))
```

```{r}
DimPlot(myeloid,reduction = "tsne",group.by = "hashtag")
```
```{r}
g <- DimPlot(myeloid, reduction = "tsne",group.by = "hashtag")
ggsave(filename = paste0(outdir,"Supp_hashtag_tSNE_plots_4-7-24/","Supp_myeloid_TSNE_hashtag_unsplit.pdf"), plot = g, units = "cm",height = 10,width = 12)

g <- DimPlot(myeloid, reduction = "tsne",group.by = "hashtag",split.by = "orig.ident")
ggsave(filename = paste0(outdir,"Supp_hashtag_tSNE_plots_4-7-24/","Supp_myeloid_TSNE_hashtag_split.pdf"), plot = g, units = "cm",height = 10,width = 20)
```

### mono_mac

```{r}
load(paste0(indir,"mono_mac_V2p4_sp.Robj"))
```

```{r}
DimPlot(mono_mac,reduction = "tsne",group.by = "hashtag")
```

```{r}
g <- DimPlot(mono_mac, reduction = "tsne",group.by = "hashtag")
ggsave(filename = paste0(outdir,"Supp_hashtag_tSNE_plots_4-7-24/","Supp_mono-mac_TSNE_hashtag_unsplit.pdf"), plot = g, units = "cm",height = 10,width = 12)

g <- DimPlot(mono_mac, reduction = "tsne",group.by = "hashtag",split.by = "orig.ident")
ggsave(filename = paste0(outdir,"Supp_hashtag_tSNE_plots_4-7-24/","Supp_mono-mac_TSNE_hashtag_split.pdf"), plot = g, units = "cm",height = 10,width = 20)
```
...
```{r}
DimPlot(DC,reduction = "tsne",group.by = "hashtag")
DimPlot(DC,reduction = "tsne",group.by = "annotation",label = T)
```

```{r}
g <- DimPlot(DC, reduction = "tsne",group.by = "hashtag")
ggsave(filename = paste0(outdir,"Supp_hashtag_tSNE_plots_4-7-24/","Supp_DC_TSNE_hashtag_unsplit.pdf"), plot = g, units = "cm",height = 10,width = 12)
g <- DimPlot(DC,reduction = "tsne",group.by = "annotation")
ggsave(filename = paste0(outdir,"Supp_hashtag_tSNE_plots_4-7-24/","Supp_DC_TSNE_label_unsplit.pdf"), plot = g, units = "cm",height = 10,width = 12)
g <- DimPlot(DC, reduction = "tsne",group.by = "hashtag",split.by = "orig.ident")
ggsave(filename = paste0(outdir,"Supp_hashtag_tSNE_plots_4-7-24/","Supp_DC_TSNE_hashtag_split.pdf"), plot = g, units = "cm",height = 10,width = 20)
```

### Neutrophil

```{r}
load(paste0(indir,"neutrophil_V2p4_sp.Robj"))
```

```{r}
DimPlot(neutrophil_sp,reduction = "tsne",group.by = "hashtag")
DimPlot(neutrophil_sp,reduction = "tsne",group.by = "annotation",label = T)
```

```{r}
g <- DimPlot(neutrophil_sp, reduction = "tsne",group.by = "hashtag")
ggsave(filename = paste0(outdir,"Supp_hashtag_tSNE_plots_4-7-24/","Supp_neutrophil_TSNE_hashtag_unsplit.pdf"), plot = g, units = "cm",height = 10,width = 12)
g <- DimPlot(neutrophil_sp,reduction = "tsne",group.by = "annotation")
ggsave(filename = paste0(outdir,"Supp_hashtag_tSNE_plots_4-7-24/","Supp_neutrophil_TSNE_label_unsplit.pdf"), plot = g, units = "cm",height = 10,width = 12)
g <- DimPlot(neutrophil_sp, reduction = "tsne",group.by = "hashtag",split.by = "orig.ident")
ggsave(filename = paste0(outdir,"Supp_hashtag_tSNE_plots_4-7-24/","Supp_neutrophil_TSNE_hashtag_split.pdf"), plot = g, units = "cm",height = 10,width = 20)
```
...
```{r}
load(paste0(indir,"stromal_V2p4_sp.Robj"))
```

```{r}
DimPlot(stromal,reduction = "tsne",group.by = "hashtag")
```

```{r}
g <- DimPlot(stromal, reduction = "tsne",group.by = "hashtag")
ggsave(filename = paste0(outdir,"Supp_hashtag_tSNE_plots_4-7-24/","Supp_stromal_TSNE_hashtag_unsplit.pdf"), plot = g, units = "cm",height = 8,width = 10)

g <- DimPlot(stromal, reduction = "tsne",group.by = "hashtag",split.by = "orig.ident")
ggsave(filename = paste0(outdir,"Supp_hashtag_tSNE_plots_4-7-24/","Supp_stromal_TSNE_hashtag_split.pdf"), plot = g, units = "cm",height = 8,width = 16)
```

### EC

```{r}
EC <- subset(stromal, subset = celltype == "EC")
```

```{r}
DimPlot(EC,reduction = "tsne",group.by = "hashtag")
```

```{r}
g <- DimPlot(EC, reduction = "tsne",group.by = "hashtag")
ggsave(filename = paste0(outdir,"Supp_hashtag_tSNE_plots_4-7-24/","Supp_EC_TSNE_hashtag_unsplit.pdf"), plot = g, units = "cm",height = 8,width = 10)
g <- DimPlot(EC, reduction = "tsne",group.by = "hashtag",split.by = "orig.ident")
ggsave(filename = paste0(outdir,"Supp_hashtag_tSNE_plots_4-7-24/","Supp_EC_TSNE_hashtag_split.pdf"), plot = g, units = "cm",height = 8,width = 16)
```
...
```{r}
DimPlot(CAF,reduction = "tsne",group.by = "hashtag")
```

```{r}
g <- DimPlot(CAF, reduction = "tsne",group.by = "hashtag")
ggsave(filename = paste0(outdir,"Supp_hashtag_tSNE_plots_4-7-24/","Supp_CAF_TSNE_hashtag_unsplit.pdf"), plot = g, units = "cm",height = 8,width = 10)
g <- DimPlot(CAF, reduction = "tsne",group.by = "hashtag",split.by = "orig.ident")
ggsave(filename = paste0(outdir,"Supp_hashtag_tSNE_plots_4-7-24/","Supp_CAF_TSNE_hashtag_split.pdf"), plot = g, units = "cm",height = 8,width = 16)
```
